...
*(a::Operator{BL,BR,<:AbstractMatrix}, b::Ket{BR}) where {BL<:Basis,BR<:Basis} = Ket{BL}(a.basis_l, a.data*b.data)
# *(a::Operator, b::Ket) = throw(IncompatibleBases())
*(a::Bra{BL}, b::Operator{BL,BR,<:AbstractMatrix}) where {BL<:Basis,BR<:Basis} = Bra{BR}(b.basis_r, transpose(b.data)*a.data)
# *(a::Bra, b::Operator) = throw(IncompatibleBases())
*(a::Operator{B1,B2,<:AbstractMatrix}, b::Operator{B2,B3,<:AbstractMatrix}) where {B1<:Basis,B2<:Basis,B3<:Basis} = Operator(a.basis_l, b.basis_r, a.data*b.data)
# *(a::Operator, b::Operator) = throw(IncompatibleBases())
